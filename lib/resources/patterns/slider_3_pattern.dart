...
class _ThreeSliderWidgetState extends State<ThreeSliderWidget>
  ...
  Widget build(BuildContext context) {
    ...
    return ValueListenableBuilder<int>(
      ...
      builder: (BuildContext context, int value, Widget? child) =>
          Stack(clipBehavior: Clip.none, children: _getStackChildren(value)),
    );
  }
                            ...
                            if (_res == 0) {
                              setState(() {
                                if (_isSwitched) {
                                  _isSwitched = false;
                                  _absoluteValue =
                                      _scale[0]["value"] / _scale[0]["r"];
                                  rotationController.forward(from: 0.0);
                                } else {
                                  _isSwitched = true;
                                  _absoluteValue =
                                      _scale[1]["value"] / _scale[1]["r"];
        ...
        child: Container(
          child: Column(
            ...
            children: _isSwitched
                ? _getPercentWidgets(1)
                : _getPercentWidgets(0),
          ),
        ),
      ),
    );
  ...
  Widget _sliderCard() {
    Map<String, dynamic> imap = {
      ...
      "_child": Text('+', style: bannerTxtStyle),
    };
    Widget pb = GestureDetector(
      onTap: () => _onTap("+"),
      child: ColorButton(imap),
    );
              ...
              Row(
                children: [
                  Container(
                    ...
                    child: Text(_ys, style: sliderBoldTextStyle),
                  ),
                  Container(
                    margin: EdgeInsets.only(
                      right: width * 0.04,
              ...
              Row(
                children: [
                  ...
                  Container(
                    ...
                    child: Row(children: [mb, const SizedBox(width: 20.0), pb]),
                  ),
                ],
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
              ),
  ...
  List<Widget> _getPercentWidgets(int i) {
    ...
    return [
      ...
      Container(
        margin: EdgeInsets.only(left: width * 0.04),
        child: Text(_scale[i]["t"], style: sliderTextStyle),
      ),
      Container(
        margin: EdgeInsets.only(left: width * 0.04, top: height * 0.01),
        child: (_res != 1)
            ? Text(_scale[i]["text"], style: sliderSmallTextStyle)
            : Row(
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
      ...
      Container(
        ...
        child: Row(
          children: [
            ...
            const Spacer(),
            Text(
              numString(_scale[i]["end"], dec: _dec[i]) + ' ' + _scale[i]["s"],
              style: sliderSmallTextStyle,
            ),
          ],
        ),
  ...
  _buildSliderResult() {
    ...
    List<Widget> wl = [
      Text(_mv["_ans1"].toString() + map["_suffix1"], style: ts),
    ];
    ...
    wl = [Text(_mv["_ans2"].toString() + map["_suffix2"], style: ts)];
    m1["resCol"] = Container(
      alignment: Alignment.centerLeft,
    ...
    Widget ansC = Container(
      ...
      child: Text(model.map["text"]["Answer"], style: ts),
    );
    ...
    wl = [Text(_mv["_ans3"].toString() + map["_suffix3"], style: ts)];
    m1["resCol"] = Container(
      alignment: Alignment.centerLeft,
      margin: EdgeInsets.only(left: size20),
      child: Column(
